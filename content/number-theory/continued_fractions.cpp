/*
 * Author: Enzo de Almeida Rodrigues 
     heavily inspired by cp algorithms' "Continued Fractions" article

 * Description: Useful when working with fractions, computes continued fraction from fraction and vice-versa
     lca(u, v): computes the lca of fractions u and v on Stern-Brocott Tree 

 * Tested: only on problem https://atcoder.jp/contests/abc408/tasks/abc408_g (example 1) 
